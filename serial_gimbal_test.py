...
def control_parser():
    ...
    Psl = " 00" # Pitch speed low byte 
    Psh = " 00" # Pitch speed high byte | 0.1220740379 degree/sec | (2 byte signed, little-endian order)
    Pal = " 00" # Pitch angle low byte 
    Pah = " 00" # Pitch angle  high byte | 0.02197265625 degree | (2 byte signed, little-endian order)
    Ysl = " E1" # Yaw speed low byte 
    Ysh = " FF" # Yaw speed high byte | 0.1220740379 degree/sec | (2 byte signed, little-endian order)
